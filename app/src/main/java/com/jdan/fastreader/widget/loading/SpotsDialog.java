package com.jdan.fastreader.widget.loading;
...
//        setCancelable(false);
    ...
    private void initProgress() {
        ...
        int size = getContext().getResources().getDimensionPixelSize(R.dimen.base5dp);
        int progressWidth = getContext().getResources().getDimensionPixelSize(R.dimen.base250dp);
